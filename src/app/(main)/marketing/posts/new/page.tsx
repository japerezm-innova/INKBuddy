...
import { PostPlanner } from '@/features/marketing/components'
import { Send } from 'lucide-react'

export const metadata = {
  title: 'Nueva Publicacion | Marketing | INKBuddy',
  description: 'Planifica una nueva publicacion para redes sociales',
}
